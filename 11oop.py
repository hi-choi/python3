...
def readSungJuk():
    ...
    #computeSungJuk(name,kor,eng,mat)
...
class Employee:
    ...
    def __str__(self):
        result = f'{self.empno} {self.lname} {self.fname} {self.email} {self.phone} {self.hdate}' \
                 f'{self.jobid} {self.sal} {self.comm} {self.mgr} {self.deptid}'
        return result

emp = Employee(123,'Steven','King','SKING','1234567','2003-06-17','AD_PRES',24000,'','',90)
print(emp)