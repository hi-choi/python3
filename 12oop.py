...
sj2 = SungJuk2('Lisa',86,54,76)
print(sj2)

print(sj2.name)  # 방법2
                 # private 변수는 객체명.변수명으로 다룰 수 없음
                 # setter, getter를 이용해서 호출하면 출력
sj2.getName()    # 방법1
