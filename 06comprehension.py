...
sqllist4 = [ v ** 2 for v in val if type(v) == int ]
...
square2 = [i for i in range(1,100+1) if sqrt(i) % 1 != 0]
# square2 = [i for i in range(1,100+1) if sqrt(i) - int(sqrt(i)) != 0]
square2
